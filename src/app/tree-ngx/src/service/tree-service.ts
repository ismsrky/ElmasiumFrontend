...
export class TreeService {
  ...
  private editItemSubject: Subject<NodeItem<any>>;
  private newItemSubject: Subject<NodeItem<any>>;
  private deleteItemSubject: Subject<NodeItem<any>>;

  constructor() {
    this.editItemSubject = new Subject<NodeItem<any>>();
    this.newItemSubject = new Subject<NodeItem<any>>();
    this.deleteItemSubject = new Subject<NodeItem<any>>();
  ...
  editItem(nodeItem: NodeItem<any>): void {
    this.editItemSubject.next(nodeItem);
  }
  newItem(nodeItem: NodeItem<any>): void {
    this.newItemSubject.next(nodeItem);
  }
  deleteItem(nodeItem: NodeItem<any>): void {
    this.deleteItemSubject.next(nodeItem);
  }
  ...
  getEditItemObs(): Observable<NodeItem<any>> {
    return this.editItemSubject.asObservable();
  }
  getNewItemObs(): Observable<NodeItem<any>> {
    return this.newItemSubject.asObservable();
  }
  getDeleteItemObs(): Observable<NodeItem<any>> {
